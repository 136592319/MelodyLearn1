...
const RhythmGame = dynamic(() => import('@/components/games/RhythmGame'), { ssr: false });
const PitchGame = dynamic(() => import('@/components/games/PitchGame'), { ssr: false });
const VirtualPiano = dynamic(() => import('@/components/games/VirtualPiano'), { ssr: false });
const PianoBeatBuilder = dynamic(() => import('@/components/games/MemoryGame'), { ssr: false });
